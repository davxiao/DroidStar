...
public:
  ...
  void init(QString callsign, uint32_t dmrid, uint16_t nxdnid, char module,
            QString refname, QString host, int port, bool ipv6, QString vocoder,
            QString modem, QString audioin, QString audioout, bool mdirect);
  void set_modem_flags(bool rxInvert, bool txInvert, bool pttInvert,
  ...
  void set_modem_params(uint32_t baud, uint32_t rxfreq, uint32_t txfreq,
                        uint32_t txDelay, float rxLevel, float rfLevel,
                        uint32_t ysfTXHang, float cwIdTXLevel,
                        float dstarTXLevel, float dmrTXLevel, float ysfTXLevel,
                        float p25TXLevel, float nxdnTXLevel,
  ...
  virtual void set_dmr_params(uint8_t, QString, QString, QString, QString,
                              QString, QString, QString, QString, QString,
                              QString) {}
  virtual void set_iax_params(QString, QString, QString, QString, QString,
                              int) {}
...
signals:
  ...
  // Request that the application toggle the main connect button (same hook as
  // UI)
...
protected slots:
  ...
  void begin_connect();
  void input_src_changed(int id, QString t) {
    m_ttsid = id;
    m_ttstext = t;
  }
  void start_tx();
